...
CITY_TO_CURRENCY = {
    ...
    "ottawa": "CAD", "edmonton": "CAD", "winnipeg": "CAD", "quebec city": "CAD",
    "mexico city": "MXN", "guadalajara": "MXN", "monterrey": "MXN", "cancun": "MXN",
    "tijuana": "MXN", "puebla": "MXN", "playa del carmen": "MXN",
    
    # South America
    "sao paulo": "BRL", "rio de janeiro": "BRL", "brasilia": "BRL", "salvador": "BRL",
    "fortaleza": "BRL", "belo horizonte": "BRL", "manaus": "BRL", "curitiba": "BRL",
    "buenos aires": "ARS", "cordoba": "ARS", "rosario": "ARS", "mendoza": "ARS",
    ...
    "caracas": "VES", "maracaibo": "VES", "valencia": "VES",
    
    # Oceania
    "sydney": "AUD", "melbourne": "AUD", "brisbane": "AUD", "perth": "AUD",
    "adelaide": "AUD", "gold coast": "AUD", "canberra": "AUD", "darwin": "AUD",
    "auckland": "NZD", "wellington": "NZD", "christchurch": "NZD", "hamilton": "NZD",
    "suva": "FJD", "nadi": "FJD",
    
    # Africa
    "cape town": "ZAR", "johannesburg": "ZAR", "durban": "ZAR", "pretoria": "ZAR",
    ...
    "bucharest": "RON", "cluj-napoca": "RON", "timisoara": "RON", "iasi": "RON",
    ...
    "moscow": "RUB", "saint petersburg": "RUB", "novosibirsk": "RUB", "yekaterinburg": "RUB",
...
def test_currency_conversion():
    ...
    # Test USD to JPY (Japanese Yen)
    result = get_rate_from_usd_to("JPY")
    print(f"USD to JPY: {result}")
    
    # Test a few other currencies
    currencies_to_test = ["EUR", "GBP", "CAD", "AUD", "CHF"]
    
    for currency in currencies_to_test:
        result = get_rate_from_usd_to(currency)
        print(f"USD to {currency}: {result}")

# Run the test
if __name__ == "__main__":
    # Make sure you have your API key set as an environment variable
    if not API_KEY:
        print("Error: Please set EXCHANGE_RATE_API_KEY environment variable")
    else:
